...
if(isset($_SESSION['idUsuario']) && empty($_SESSION['idUsuario'])==false && $_SESSION['tipoUsuario'] == 2|| $_SESSION['tipoUsuario'] ==99){
    ...
    $sql="UPDATE check_list SET qtde_nf = :qtdNf, valor_carga = :valorCarga, data_saida = :dataSaida, horimetro = :horimetro, rota = :rota, peso_carga = :pesoCarga, num_carregemento = :numCarga, motorista = :motorista, situacao=:situacao, km_inicial = :kmInicial WHERE idcheck_list = :id";
