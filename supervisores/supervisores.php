...
<body>
            ...
            <div class="menu-principal">
                <div class="icon-exp">
                    <div class="area-opcoes-button">
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalAdd" data-whatever="@mdo" name="idpeca">Novo Supervisor</button>
                    </div>
                </div>
    ...
    <script>
        ...
        //abrir modal
        $('#tableSupervisores').on('click', '.editbtn', function(event){
            var table = $('#tableSupervisores').DataTable();
...
<script>
   ...
   function confirmaDelete(id){
        Swal.fire({
            title: 'Tem certeza?',
            text: 'Você realmente deseja excluir este Supervisor?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'excluir-supervisor.php?codigo=' + id;
            }
        });
    }
</script>
