...
if($filial===99){
    ...
    $condicao = "AND supervisores.filial=$filial";
}
...
$stmt = $db->prepare("SELECT COUNT(*) AS allcount FROM supervisores WHERE 1 $condicao");
$stmt->execute();
$records = $stmt->fetch();
$totalRecords = $records['allcount'];

## Total number of records with filtering
$stmt = $db->prepare("SELECT COUNT(*) AS allcount FROM supervisores WHERE 1 $condicao ".$searchQuery);
