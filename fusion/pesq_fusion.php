...
$searchQuery = " ";
if($searchValue != ''){
	$searchQuery = " AND (carregamento LIKE :carregamento OR placa_veiculo LIKE :placa_veiculo OR nome_motorista LIKE :nome_motorista OR nome_rota LIKE :nome_rota ) ";
    $searchArray = array( 
...
foreach($empRecords as $row){
    $data[] = array(
            ...
            "termino_rota"=>date("d/m/Y ", strtotime($row['termino_rota'])),
            "chegada_empresa"=>date("d/m/Y ", strtotime($row['chegada_empresa'])),
