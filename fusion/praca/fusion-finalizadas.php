    ...
    <div class="container-fluid corpo">
        ...
        <div class="tela-principal">
            <div class="menu-superior">
                ...
                <div class="title">
                    <h2>Viagens Praça Finalizada</h2>
                </div>
                    ...
                    <table id='tableFusion' class='table table-striped table-bordered nowrap text-center' style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center text-nowrap" >% Entregas</th>
                                <th scope="col" class="text-center text-nowrap">% Prestação de Contas</th>
    ...
    <script>
        $(document).ready(function(){
            $('#tableFusion').DataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url':'pesq_fusion_finalizada.php'
                },
                'columns': [
                    { data: 'data_saida'},
