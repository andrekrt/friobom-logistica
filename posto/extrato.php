    ...
    <div class="container-fluid corpo">
        ...
        <div class="tela-principal">
            ...
            <div class="menu-principal">
                <div class="icon-exp">
                    <a href="extrato-xls.php" ><img src="../assets/images/excel.jpg" alt=""></a>
                </div>
                    ...
                    <table id='extrato' class='table table-striped table-bordered nowrap text-center' style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center text-nowrap">Volume(lt)</th>
                                <th scope="col" class="text-center text-nowrap">Carregamento</th>
                                <th scope="col" class="text-center text-nowrap">Placa/Fornecedor</th>
