...
if($sql){
    ...
    foreach($dados as $dado){
        ...
        $percDaCarga =number_format(($gastosViagens/$dado['valor_transportado'])*100,2,) ;
    ...
    <body>
        ...
        <table style='margin-top:10px; width:100%'>
            ...
            <tbody>
                ...
                <tr>
                    <td style='font-size:8pt;border:1px solid black;'>Almoço</td>
                ...
                <tr>
                    <td style='font-size:8pt;border:1px solid black;'>Passagem</td>
