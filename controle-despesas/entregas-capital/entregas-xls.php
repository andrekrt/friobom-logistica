    ...
    <body>
        <?php
            ...
            if($tipoUsuario==10 || $tipoUsuario==99){
                ...
                $html .= '<td class="text-center font-weight-bold"> Sequência </td>';
