                ...
                <div class="menu-principal">
                    <div class="filtro">
                        <form class="form-inline" action="" method="post">
                            <div class="form-row">
                                <select name="placa" id="motorista" class="form-control">
                                    <option value=""></option>
                                    <?php
                    ...
                    <nav aria-label="Navegação de página exemplo" class="paginacao">
                        <ul class="pagination">
                            ...
                            <?php
                                if($paginaAnterior!=0){
                                    echo "<a class='page-link' href='gastos.php?pagina=$paginaAnterior' aria-label='Anterior'>
                            ...
                            <?php
                                for($i=1;$i < $numPaginas+1;$i++){
                                    echo "<li class='page-item'><a class='page-link' href='gastos.php?pagina=$i'>$i</a></li>";
                                }
                            ?>
                            <li class="page-item">
                            <?php
                                if($paginaPosterior <= $numPaginas){
                                    echo " <a class='page-link' href='gastos.php?pagina=$paginaPosterior' aria-label='Próximo'>
