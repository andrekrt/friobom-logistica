                    ...
                    <table id='tableRelatorio' class='table table-striped table-bordered nowrap text-center' style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center text-nowrap"> Total Abastecido(Lt)</th>
                                <th scope="col" class="text-center text-nowrap"> Valor Abastecido(R$)</th>
                                <th scope="col" class="text-center text-nowrap"> Nº Solicitações</th>
                                <th scope="col" class="text-center text-nowrap"> Valores das Solicitações</th>
                                <th scope="col" class="text-center text-nowrap"> R$/KM</th>
                            </tr>
                        </thead>
