                ...
                <form action="atualiza.php" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select name="funcao" required id="funcao" class="form-control funcao">
                                <option value=""></option>
...
<script >
    ...
    function confirmaDelete(id){
        Swal.fire({
            title: 'Tem certeza?',
            text: 'Você realmente deseja Desativar este Colaborador?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'excluir-colab.php?id=' + id;
            }
        });
    }
</script>
