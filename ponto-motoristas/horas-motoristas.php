...
<body>
        ...
        <div class="tela-principal">
            <div class="menu-superior">
                <div class="icone-menu-superior">
                    <img src="../assets/images/icones/icone-horas.png" alt="">
                </div>
                <div class="title">
            ...
            <div class="menu-principal">
                <div class="table-responsive">
                    <!-- Adicione inputs de data para filtrar por intervalo -->
                    <div class="table-responsive">
                        <div class="mb-3">
                            <label for="dataInicial">Data Inicial:</label>
                            <input type="date" class="form-control" id="dataInicial" name="startDate">
                        </div>
                        <div class="mb-3">
                            <label for="dataFinal">Data Final:</label>
                            <input type="date" class="form-control" id="dataFinal" name="endDate">
                        </div>
                    </div>
                    <table id='tableMdfe' class='table table-bordered nowrap' style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th>  Horas Parado </th>
                                <th>Horas Trabalhadas Líquidas </th>
                            </tr>
                        </thead>
                    </table>
                </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            let dataTable = $('#tableMdfe').DataTable({
                'processing': true,
                'serverSide': true,
                'serverMethod': 'post',
                ajax: {
            ...
            // Adicionar listener de evento para alteração de data
