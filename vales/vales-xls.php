...
$escreve = fwrite($fp, mb_convert_encoding('Nº','ISO-8859-1', 'UTF-8'). ";Data;Motorista; Rota; Valor (R$); Tipo Vale; Carregamento; Status;". mb_convert_encoding("Usuário",'ISO-8859-1', 'UTF-8') );
