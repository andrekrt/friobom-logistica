...
<html lang="pt-br">
    <head>
        ...
        <title>Cadastro de Véiculo</title>
                ...
                <div class="opcoes">
                    ...
                    <div class="item">
                        <a onclick="menuDespesas()">
                            <img src="assets/images/despesas.png" alt="">
                        </a>
                        <nav id="submenuDespesa">
                            <ul class="nav flex-column">
                                <li class="nav-item"> <a class="nav-link" href="controle-despesas/analise-geral.php"> Análises </a> </li>
